    ...
    await prisma.verse.createMany({
      data: [
        ...
        },
        {
          ...
          transliteration:
            "Qul ya ahla l-kitabi ta'alaw ila kalimatin sawa'in baynana wa baynakum",
          translation:
    ...
    await prisma.tafsir.createMany({
      data: [
        ...
        },
        {
          ...
          methodTags: ["RIVAYET", "DIRAYET", "ZAHIR", "AHKAM"],
        },
        {
          id: "tafsir-3-64-razi",
          verseId: "verse-3-64",
          ...
          methodTags: ["DIRAYET", "TEMATIK", "ISARI", "AHKAM"],
        },
        {
